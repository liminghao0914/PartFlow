...
.method private drawChipBackground(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    iget-object v1, p0, Landroid/support/design/chip/ChipDrawable;->chipPaint:Landroid/graphics/Paint;
...
.method private drawText(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    iget-object v3, p0, Landroid/support/design/chip/ChipDrawable;->fontCallback:Landroid/support/v4/content/res/ResourcesCompat$FontCallback;
...
.method private loadFromAttributes(Landroid/util/AttributeSet;II)V
    ...
    .line 346
    iget-object p3, p0, Landroid/support/design/chip/ChipDrawable;->context:Landroid/content/Context;
    ...
    .line 382
    sget p3, Landroid/support/design/R$styleable;->Chip_chipIconEnabled:I
    ...
    sget v1, Landroid/support/design/R$styleable;->Chip_chipIcon:I

    invoke-static {p3, p2, v1}, Landroid/support/design/resources/MaterialResources;->getDrawable(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    invoke-virtual {p0, p3}, Landroid/support/design/chip/ChipDrawable;->setChipIcon(Landroid/graphics/drawable/Drawable;)V

    .line 385
    iget-object p3, p0, Landroid/support/design/chip/ChipDrawable;->context:Landroid/content/Context;

    sget v1, Landroid/support/design/R$styleable;->Chip_chipIconTint:I

    invoke-static {p3, p2, v1}, Landroid/support/design/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p3

    invoke-virtual {p0, p3}, Landroid/support/design/chip/ChipDrawable;->setChipIconTint(Landroid/content/res/ColorStateList;)V

    .line 386
    sget p3, Landroid/support/design/R$styleable;->Chip_chipIconSize:I

    invoke-virtual {p2, p3, v0}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result p3

    invoke-virtual {p0, p3}, Landroid/support/design/chip/ChipDrawable;->setChipIconSize(F)V

    .line 388
    sget p3, Landroid/support/design/R$styleable;->Chip_closeIconVisible:I

    invoke-virtual {p2, p3, v6}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p3

    invoke-virtual {p0, p3}, Landroid/support/design/chip/ChipDrawable;->setCloseIconVisible(Z)V
    ...
    .line 394
    sget p3, Landroid/support/design/R$styleable;->Chip_closeIconEnabled:I
    ...
    sget v1, Landroid/support/design/R$styleable;->Chip_closeIcon:I

    invoke-static {p3, p2, v1}, Landroid/support/design/resources/MaterialResources;->getDrawable(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    invoke-virtual {p0, p3}, Landroid/support/design/chip/ChipDrawable;->setCloseIcon(Landroid/graphics/drawable/Drawable;)V

    .line 397
    iget-object p3, p0, Landroid/support/design/chip/ChipDrawable;->context:Landroid/content/Context;

    sget v1, Landroid/support/design/R$styleable;->Chip_closeIconTint:I
    ...
    .line 397
    invoke-virtual {p0, p3}, Landroid/support/design/chip/ChipDrawable;->setCloseIconTint(Landroid/content/res/ColorStateList;)V

    .line 399
    sget p3, Landroid/support/design/R$styleable;->Chip_closeIconSize:I

    invoke-virtual {p2, p3, v0}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result p3

    invoke-virtual {p0, p3}, Landroid/support/design/chip/ChipDrawable;->setCloseIconSize(F)V

    .line 401
    sget p3, Landroid/support/design/R$styleable;->Chip_android_checkable:I

    invoke-virtual {p2, p3, v6}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p3

    invoke-virtual {p0, p3}, Landroid/support/design/chip/ChipDrawable;->setCheckable(Z)V

    .line 402
    sget p3, Landroid/support/design/R$styleable;->Chip_checkedIconVisible:I

    invoke-virtual {p2, p3, v6}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p3

    invoke-virtual {p0, p3}, Landroid/support/design/chip/ChipDrawable;->setCheckedIconVisible(Z)V
    ...
    .line 410
    :cond_2
    iget-object p1, p0, Landroid/support/design/chip/ChipDrawable;->context:Landroid/content/Context;
...
.method private onStateChange([I[I)Z
    ...
    iget v2, p0, Landroid/support/design/chip/ChipDrawable;->currentTint:I
...
.method public setCloseIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_0
    iput-object p1, p0, Landroid/support/design/chip/ChipDrawable;->closeIcon:Landroid/graphics/drawable/Drawable;
